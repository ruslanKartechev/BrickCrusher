...
namespace Services.Particles.Service.Impl
{
    public class ParticlesService : MonoBehaviour, IParticlesService
    {
        ...
        private Dictionary<ParticleEffectName, HashSet<TimedData>> _timedData = new Dictionary<ParticleEffectName, HashSet<TimedData>>();
        ...
        public ParticleSystem PlayParticles(PlayParticlesArg args)
        {
            ...
            if (args.timed)
            {
                ...
                {
                    Duration = args.duration, Elapsed = 0f, IsAvailable = false,
        ...
        private ParticleSystem GetParticles(ParticleEffectName particleName)
        {
        ...
        private ParticleSystem GetFromRepository(ParticleEffectName name)
        {
